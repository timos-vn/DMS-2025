...
class CustomQuestionTimeKeeping extends StatefulWidget {
  final IconData? iconData;
  final String? title;
  final String? content;
  final bool showTwoButton;
  final bool isUserInList;

  const CustomQuestionTimeKeeping({Key? key,this.iconData, this.title, this.content,required this.showTwoButton,required this.isUserInList}) : super(key: key);
  @override
  _CustomQuestionTimeKeepingState createState() => _CustomQuestionTimeKeepingState();
}

class _CustomQuestionTimeKeepingState extends State<CustomQuestionTimeKeeping> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        backgroundColor: Colors.transparent,
                      ...
                      children: [
                        ...
                        Center(
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius:const BorderRadius.all(Radius.circular(40)),
                                color: widget.isUserInList ? Colors.purple : subColor,
                                boxShadow: <BoxShadow>[
                                  BoxShadow(
                                      color: Colors.grey.shade200,
                                      offset: const Offset(2, 4),
                              ...
                              child: Icon(widget.iconData ,size: 50,color: widget.isUserInList ? Colors.white : Colors.white,)),
                        ),
                        const SizedBox(height: 15,),
                        Center(child: Text(widget.title.toString(),style:  TextStyle(fontWeight: FontWeight.w600,fontSize: 18,color: subColor),textAlign: TextAlign.center,)),
                        const SizedBox(height: 10,),
