...
class UpdateBarCode extends StatefulWidget {
  ...
  const UpdateBarCode({Key? key,this.barcode,this.hsd}) : super(key: key);

  @override
  _UpdateBarCodeState createState() => _UpdateBarCodeState();
}
                    ...
                    children: [
                                        ...
                                        child: TextField(
                                          ...
                                          decoration: const InputDecoration(
                                            ...
                                            suffixIcon: Padding(
                                              ...
                                              child: Icon(EneftyIcons.calendar_3_outline,size: 15,),
                                            ),
                                            ...
                                            isDense: false,
                                            focusColor: subColor,
                                            hintText: 'Vui lòng nhập Hạn sử dụng của SP',
                                      ...
                                      child: Container(
                                        ...
                                        child: TextField(
                                          ...
                                          decoration: const InputDecoration(
                                            ...
                                            suffixIcon: Padding(
                                              padding: EdgeInsets.only(right: 8),
                                              child: Icon(EneftyIcons.scan_barcode_outline,size: 15,),
                                            ),
                                            suffixIconConstraints: BoxConstraints(maxWidth: 20),
                                            contentPadding: EdgeInsets.only(
                                                bottom: 0, right: 20,left: 0),
                                            focusColor: subColor,
                                            hintText: 'Vui lòng nhập mã barcode',
                                            hintStyle: TextStyle( color: Colors.grey),
                                          ),
                                          // focusNode: focusNodeContent,
                                          keyboardType: TextInputType.text,
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.pop(context,[barcodeController.text,hsdController.text]);
                            },
                            child: const Align(
