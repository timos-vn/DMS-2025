...
import '../../../animation_widget/auth_card_login_builder.dart';
...
class __HeaderState extends State<_Header> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: SizedBox(
        height: (widget.height - MediaQuery.of(context).padding.top - 20),
        child: Column(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            GradientBox(
              colors: [
                loginTheme.pageColorLight ?? const Color.fromARGB(242, 255, 252, 252),
                loginTheme.pageColorDark ?? const Color.fromARGB(242, 255, 252, 252),
              ],
