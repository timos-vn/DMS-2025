...
import 'customer_all_bloc.dart';
import 'customer_all_event.dart';
import 'customer_all_sate.dart';

class ManagerCustomerAllScreen extends StatefulWidget {
  const ManagerCustomerAllScreen({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _ManagerCustomerAllScreenState();
  }
}

class _ManagerCustomerAllScreenState extends State<ManagerCustomerAllScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: BlocProvider<ManagerCustomerAllBloc>(
                      ...
                      itemBuilder: (context, index) {
                        return index >= length
                          ...
                          child: const PendingAction(),
                            ...
                            : GestureDetector(
                          onTap: ()=> Navigator.push(context, MaterialPageRoute(builder: (context)=> DetailInfoCustomerScreen(idCustomer: _list[index].customerCode.toString().trim(),))),
                          child: Card(
                            elevation: 2,
