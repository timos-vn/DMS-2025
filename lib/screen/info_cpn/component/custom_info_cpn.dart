...
import 'package:dms/screen/login/component/login_theme.dart';
...
import '../../../animation_widget/auth_card_infocpn_builder.dart';
import '../../../animation_widget/fade_in.dart';
import '../../../animation_widget/hero_text.dart';
import '../../../themes/color_helper.dart';
import '../../../themes/gradient_box.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.titleTag != null && !Utils.isNullOrEmpty(widget.title)) {
      title = HeroText(
        ...
        style: const TextStyle(color: Color.fromARGB(255, 0, 51, 114),fontWeight: FontWeight.w800),
...
class _CustomInfoCPNState extends State<CustomInfoCPN> with TickerProviderStateMixin {
  ...
  final double _selectTimeDilation = 1.0;
  ...
  Widget _buildDebugAnimationButtons() {
    return Positioned(
      ...
      child: Row(
        ...
        children:<Widget>[
          GestureDetector(
            onTap: ()=> Utils.showCustomToast(context, Icons.abc, 'SSE - 22/11/2025 - In mẫu PDF chi tiết đơn hàng'),
