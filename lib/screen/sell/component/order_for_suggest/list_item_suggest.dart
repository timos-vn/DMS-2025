                      ...
                      Expanded(
                        child: Row(
                          children: [
                            ...
                            Expanded(child: Text('[${_dataListSearch[index].maVt.toString().trim().replaceAll('null', '')??''}]${_dataListSearch[index].tenVt.toString().trim().replaceAll('null', '')??''}',style:const TextStyle(color: Colors.black),maxLines: 4,overflow: TextOverflow.ellipsis,)),
                          ],
                        ),
                      ),
                      const SizedBox(width: 10,),
                      ...
                      Expanded(
                        child: Row(
                          children: [
                            ...
                            Expanded(child: Text('[${_dataListSearch2[index].code.toString().trim().replaceAll('null', '')??''}]${_dataListSearch2[index].name.toString().trim().replaceAll('null', '')??''}',style:const TextStyle(color: Colors.black,),maxLines: 4,overflow: TextOverflow.ellipsis,)),
                          ],
                        ),
                      ),
                      const SizedBox(width: 10,),
