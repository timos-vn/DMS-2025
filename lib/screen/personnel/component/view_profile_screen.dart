        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Row(
                children: <Widget>[
                  Image.asset("assets/icons/doctor_pic2.png", height: 220),
                  const SizedBox(
                    width: 20,
                  ),
                  SizedBox(
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            IconTile(
                              ...
                              imgAssetPath: "assets/icons/video_call.png",
                            ),
                          ],
                        )
                      ],
...
class IconTile extends StatelessWidget {
  ...
  IconTile({Key? key, this.imgAssetPath, this.backColor}) : super(key: key);
