...
class CreateRefundOrderRequest {
  CreateRefundOrderRequestData? requestData;

  CreateRefundOrderRequest({this.requestData});

  CreateRefundOrderRequest.fromJson(Map<String, dynamic> json) {
    requestData = json['Data'] != null ?  CreateRefundOrderRequestData.fromJson(json['Data']) : null;
  }
...
class CreateRefundOrderRequestData {
  String? sct;
  String? customerCode;
  String? saleCode;
  String? orderDate;
  ...
  String? datePayment;
  List<GetDetailOrderCompletedResponseData>? detail;
  ...
  CreateRefundOrderRequestData.fromJson(Map<String, dynamic> json) {
    sct = json['sct'];
    ...
    if (json['Detail'] != null) {
      detail = <GetDetailOrderCompletedResponseData>[];
      json['Detail'].forEach((v) {
        detail!.add( GetDetailOrderCompletedResponseData.fromJson(v));
      });
    }
