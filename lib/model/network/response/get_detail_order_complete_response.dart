class GetDetailOrderCompletedResponse {
  List<GetDetailOrderCompletedResponseData>? data;
  int? totalPage;
  int? statusCode;
  String? message;

  GetDetailOrderCompletedResponse(
      {this.data, this.totalPage, this.statusCode, this.message});

  GetDetailOrderCompletedResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <GetDetailOrderCompletedResponseData>[];
      json['data'].forEach((v) {
        data!.add( GetDetailOrderCompletedResponseData.fromJson(v));
      });
    }
...
class GetDetailOrderCompletedResponseData {
  String? sttRec;
  String? sttRec0;
  String? maVt;
  String? tenVt;
  ...
  GetDetailOrderCompletedResponseData(
      {this.sttRec,
        this.sttRec0,
        this.maVt,
        this.tenVt,
        ...
        this.tienNt2,
        this.tlCk,
        this.ckNt, this.isMark = false, this.slSt = 0,
        this.maHD,this.maViTri,this.maVV,this.tkCPBH, this.hdSo, this.sttRecDh,this.sttRec0Dh,
        this.tkGV, this.tkVT
      });

  GetDetailOrderCompletedResponseData.fromJson(Map<String, dynamic> json) {
    sttRec = json['stt_rec'];
